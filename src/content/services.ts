...
export const residentialServices: ServiceData[] = [
  {
    slug: 'bangun-rumah',
    title: 'Bangun Rumah',
    shortDescription: 'Pembangunan rumah tinggal dari nol dengan standar kualitas tinggi dan manajemen proyek transparan.',
    ...
    iconName: 'Home',
    features: ['Manajemen Proyek Terpadu', 'Laporan Progres Real-time', 'Kontrol Kualitas Ketat', 'Garansi Konstruksi'],
    painPoints: ['Anggaran sering membengkak tak terkendali', 'Progres terlambat dari jadwal', 'Kualitas material tidak sesuai kesepakatan'],
  ...
  },
  {
    ...
    features: ['Diagnosis Akar Masalah', 'Metode Perbaikan Tepat Guna', 'Penggunaan Material Khusus', 'Garansi Pekerjaan'],
    painPoints: ['Bocor yang tak kunjung sembuh', 'Retak dinding yang semakin melebar', 'Tukang biasa tidak bisa menyelesaikan masalah'],
...
export const facilityCareServices: ServiceData[] = [
  ...
  },
  {
    ...
    painPoints: ['Rembes yang merusak mesin/barang di dalam', 'Pekerjaan waterproofing yang selalu gagal', 'Sulit menemukan titik pasti kebocoran'],
