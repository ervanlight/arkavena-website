...
export const metadata: Metadata = {
  title: "Terima Kasih | ARKAVENA",
  description: "Terima kasih telah menghubungi ARKAVENA Construction & Facility Care. Tim kami akan segera meninjau data Anda.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex items-center justify-center p-6 pt-24">
      <div className="max-w-2xl w-full text-center">
        <FadeIn>
          <div className="bg-[#ECE8E1] p-10 md:p-16 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100">
            ...
            <div className="bg-slate-50 p-6 rounded-xl border border-slate-100 mb-10 text-left">
              <h3 className="font-bold text-[#0E1B26] mb-2 font-[family-name:var(--font-space-grotesk)]">Langkah Berikutnya:</h3>
