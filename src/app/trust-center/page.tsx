        ...
        <Container>
          <FadeIn>
            <div className="max-w-4xl">
              ...
              <div className="text-xl text-white/50 leading-relaxed font-inter max-w-3xl space-y-6">
            ...
            <div className="lg:col-span-4">
              <FadeIn>
                <div className="sticky top-32">
                  <h3 className="text-[11px] font-bold tracking-widest uppercase text-[#5B6570] mb-6 border-b border-[#C9C3B8] pb-4">
                    Navigasi Kebijakan
                  </h3>
                  <ul className="space-y-4 font-medium text-[#5B6570]">
                ...
                <div id="sertifikasi" className="scroll-mt-32">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="p-6 bg-[#ECE8E1] border border-[#C9C3B8] rounded-xl">
                      <h4 className="text-[11px] font-bold tracking-widest uppercase text-[#5B6570] mb-2">Sertifikat Badan Usaha (SBU)</h4>
                      <p className="font-bold text-[#14171B] text-lg mb-2">Jasa Pelaksana Konstruksi</p>
                      <p className="text-sm text-[#5B6570]">Terdaftar dan diverifikasi oleh LPJK (Lembaga Pengembangan Jasa Konstruksi) untuk kualifikasi pelaksanaan bangunan gedung dan sipil.</p>
                    </div>
                    <div className="p-6 bg-[#ECE8E1] border border-[#C9C3B8] rounded-xl">
                      <h4 className="text-[11px] font-bold tracking-widest uppercase text-[#5B6570] mb-2">Nomor Induk Berusaha (NIB)</h4>
                      <p className="font-bold text-[#14171B] text-lg mb-2">Izin Usaha Terintegrasi</p>
                      <p className="text-sm text-[#5B6570]">Memiliki izin usaha resmi melalui sistem OSS (Online Single Submission) dari Kementerian Investasi/BKPM.</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
