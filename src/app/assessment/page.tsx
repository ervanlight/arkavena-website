            ...
            <div className="lg:col-span-6">
              <FadeIn>
                ...
                <h1 className="text-xl md:text-2xl lg:text-4xl font-[family-name:var(--font-space-grotesk)] font-bold text-[#14171B] leading-[1.05] tracking-tight mb-8">
                  ...
                  <br /><span className="text-[#3F4954]">Pastikan Proyek Anda Sudah Siap.</span>
                </h1>
                <div className="text-lg text-[#3F4954] leading-relaxed font-[family-name:var(--font-inter)] mb-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={idx} className="flex items-start gap-3">
                        ...
                        <span className="text-[#3F4954] font-medium">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-16 p-8 bg-[#ECE8E1] border border-[#C9C3B8] rounded-xl">
                  <h3 className="text-sm font-[family-name:var(--font-ibm-plex-mono)] font-bold tracking-widest uppercase text-[#3F4954] mb-6">Assessment Mencakup</h3>
                  <div className="space-y-4 text-[#14171B] font-medium">
                    <p>Apakah lahan sudah siap?</p>
                    <ArrowDown className="w-4 h-4 text-[#3F4954]" />
