...
import { buildHomepageGraph } from '@/lib/seo/schema-builders';
import {
  ShieldAlert,
  AlertTriangle,
  EyeOff,
...
/**
 * Homepage restore (fix/homepage-restore-visual-refresh): this page was
 * rewritten in Batch 01 to render generically from the MDX content manifest
 * (PageTemplate), which visually replaced this hand-built layout without
 * that consequence being flagged to the owner beforehand. This restores the
 * pre-Batch 01 layout, section order, and copywriting verbatim, with the
 * WhatsApp CTA switched to the central config helper (the old inline
 * `wa.me/6281112345678` was a hardcoded dummy number — the same defect this
 * repo already fixed elsewhere; a plain copy-restore should not reintroduce
 * it), and a small, explicitly-scoped set of accent colors pulled from the
 * newer content-engine design system (see PR description for the mapping).
 * The `page-home` MDX entry (content/pages/home.mdx) still exists and drives
 * this route's metadata/canonical/OG and keeps "/" in the sitemap and
 * business-entity JSON-LD — only its MDX *body* is no longer rendered here.
 */
export default function HomePage() {
  ...
  const whatsappUrl = buildWhatsAppUrl({
    ...
    message: "Halo Arkavena, saya ingin berkonsultasi mengenai rencana proyek konstruksi.",
  });
  ...
  return (
    <>
      ...
      <section className="relative bg-[#14171B] pt-28 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
        ...
        <Container className="relative z-20">
          <div className="max-w-2xl">
            <FadeIn>
              <div>
                <span className="inline-block text-[11px] font-bold tracking-widest uppercase text-[#B88A4A] mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/assessment">
                    <Button size="lg" className="w-full sm:w-auto bg-[#B88A4A] text-[#14171B] hover:bg-[#a2793f]">
      ...
      <section className="bg-[#14171B] border-b border-white/10 py-6">
        <Container>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="font-[family-name:var(--font-ibm-plex-mono)] text-2xl md:text-3xl font-bold text-[#B88A4A]">100%</div>
            ...
            <div>
              <div className="font-[family-name:var(--font-ibm-plex-mono)] text-2xl md:text-3xl font-bold text-[#B88A4A]">Overrun 0%</div>
              <div className="text-xs text-white/60 font-[family-name:var(--font-inter)] uppercase tracking-wider mt-1">Pengendalian Biaya</div>
            </div>
            <div>
              <div className="font-[family-name:var(--font-ibm-plex-mono)] text-2xl md:text-3xl font-bold text-[#B88A4A]">Real-time</div>
            ...
            <div>
              <div className="font-[family-name:var(--font-ibm-plex-mono)] text-2xl md:text-3xl font-bold text-[#B88A4A]">Surabaya+</div>
      ...
      {/* 4. INSIGHT */}
      <section className="py-24 lg:py-32 bg-[#ECE8E1] border-b border-[#E8DED0]">
        <Container>
          <FadeIn>
          ...
          <FadeIn>
            <div className="grid lg:grid-cols-12 gap-16 mb-16">
              ...
              <div className="lg:col-span-6">
                ...
                <Button variant="secondary" className="border-[#E8DED0] text-[#14171B] hover:bg-[#E8DED0]/40 bg-transparent">
                  <Link href="/portfolio">Lihat Semua Studi Kasus</Link>
                </Button>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-px bg-[#E8DED0] border border-[#E8DED0]">
              <div className="bg-[#ECE8E1] hover:bg-[#E8DED0]/40 transition-colors p-8 sm:p-12 block group cursor-pointer border border-transparent hover:border-[#E8DED0]">
                <Link href="/portfolio/rumah-tinggal-citraland">
                  <div className="aspect-[4/3] bg-[#E8DED0]/40 mb-8 relative overflow-hidden rounded-lg">
      ...
      <section className="py-24 lg:py-32 bg-[#ECE8E1] bg-structural-grid border-b border-[#E8DED0]">
        <Container>
          <FadeIn>
                  ...
                  {[
                    ...
                    <div key={idx} className="flex gap-6">
                      <div className="shrink-0 mt-1">
                        <div className="w-10 h-10 bg-[#B88A4A]/10 border border-[#B88A4A]/20 rounded-lg flex items-center justify-center text-[#B88A4A]">
      ...
      {/* 8. CARA KERJA */}
      <section id="cara-kerja" className="py-24 lg:py-32 bg-[#ECE8E1] bg-structural-grid border-b border-[#E8DED0]">
        <Container>
          <FadeIn>
            <div className="max-w-3xl mb-16">
              <h2 className="text-xl md:text-2xl lg:text-3xl font-[family-name:var(--font-space-grotesk)] font-bold text-[#14171B] leading-[1.1] tracking-tight mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-y-16 gap-x-12 mb-16">
              {[
                ...
                <div key={idx} className="relative">
                  <div className="flex items-center gap-4 mb-4 border-b border-[#E8DED0] pb-4">
                    <div className="w-8 h-8 rounded bg-[#E8DED0]/50 flex items-center justify-center text-[#3F4954] shrink-0">
            ...
            <Button size="lg" className="bg-[#B88A4A] text-[#14171B] hover:bg-[#a2793f]">
      ...
      {/* 11. CTA */}
      <section className="py-24 lg:py-32 bg-[#1C2D38]">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button size="lg" variant="secondary" className="w-full sm:w-auto border-white/30 text-white bg-transparent hover:bg-white/10">
                <Link href={whatsappUrl ?? '/konsultasi-proyek'} target={whatsappUrl ? '_blank' : undefined} className="flex items-center gap-2">
