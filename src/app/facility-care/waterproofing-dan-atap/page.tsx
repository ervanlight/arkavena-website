...
export const metadata: Metadata = {
  ...
  description: "Solusi kebocoran atap dan dak beton industri maupun komersial dengan garansi pekerjaan yang jelas.",
};
  ...
  return (
    <main className="min-h-screen bg-[#ECE8E1] text-[#0E1B26]">
      <section className="relative overflow-hidden z-0 bg-[#0E1B26] text-white py-24 px-6 min-h-[70vh] flex items-center">
        <Image 
          src="/images/hero_facility_waterproofing_v4.jpg"
          alt="Hero Background"
          fill
          ...
          <div className="max-w-5xl mx-auto">
            <FadeIn>
              <div className="text-sm text-bronze font-semibold uppercase tracking-wider mb-6 flex items-center gap-2">
                ...
                <span className="text-slate-500">/</span> Waterproofing Dan Atap
              </div>
              <h1 className="text-xl md:text-2xl lg:text-4xl font-bold font-[family-name:var(--font-space-grotesk)] leading-tight mb-8 text-white max-w-4xl">
                Tuntaskan Kebocoran Atap Secara Permanen
              </h1>
              <p className="text-xl text-slate-300 max-w-2xl leading-relaxed">
                Kebocoran bukan sekadar air yang menetes, melainkan risiko kerusakan mesin produksi dan dokumen penting. Kami mengatasi kebocoran dari sumbernya.
              </p>
            </FadeIn>
          </div>
        </div>
          ...
          <FadeIn direction="left">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#0E1B26] mb-2">Waterproofing Dak Beton</h3>
                  <p className="text-[#68757D] leading-relaxed">Aplikasi membran bakar, polyurethane (PU), atau cementitious waterproofing tergantung kondisi paparan sinar matahari dan genangan.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="mt-1 bg-slate-100 p-3 rounded-xl h-fit border border-slate-200">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#0E1B26] mb-2">Perbaikan Atap Pabrik (Metal Roof)</h3>
                  <p className="text-[#68757D] leading-relaxed">Penanganan korosi, penggantian insulasi atap (glasswool), dan perbaikan sealant talang jurai.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="mt-1 bg-slate-100 p-3 rounded-xl h-fit border border-slate-200">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#0E1B26] mb-2">Injeksi Beton</h3>
                  <p className="text-[#68757D] leading-relaxed">Penanganan retak struktural pada basement atau dinding penahan tanah (retaining wall) menggunakan sistem injeksi PU.</p>
                </div>
              </div>
            </div>
          </FadeIn>
            ...
            <div className="bg-[#1C2D38] text-white p-10 rounded-2xl h-full border border-slate-700 shadow-xl shadow-slate-900/10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-2">Water Test Wajib</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Semua pekerjaan waterproofing tidak akan diserahterimakan sebelum lolos uji genang air (water test) 1x24 jam.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <CheckCircle2 className="w-6 h-6 text-bronze shrink-0 mt-1" />
                  <div>
                    <h3 className="text-lg font-bold text-white mb-2">Garansi Tertulis</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">Kami memberikan garansi pemeliharaan khusus waterproofing yang tercantum resmi di dalam kontrak.</p>
                  </div>
                </div>
              </div>
            </div>
