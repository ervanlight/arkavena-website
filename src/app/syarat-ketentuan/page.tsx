...
export const metadata: Metadata = {
  ...
  description: 'Syarat dan ketentuan penggunaan situs web dan layanan ARKAVENA.',
};
        ...
        <Container>
          <FadeIn delay={100}>
            <div className="max-w-3xl mx-auto prose prose-zinc prose-lg">
              <p>Selamat datang di situs web ARKAVENA. Dengan mengakses dan menggunakan situs ini, Anda setuju untuk terikat oleh Syarat & Ketentuan berikut. Jika Anda tidak setuju dengan ketentuan ini, mohon untuk tidak menggunakan situs kami.</p>
              ...
              <p>Seluruh konten, desain, grafik, logo, dan teks di situs web ini adalah milik ARKAVENA atau pemberi lisensinya dan dilindungi oleh undang-undang hak cipta. Anda tidak diperkenankan untuk menyalin, mereproduksi, atau mendistribusikan materi apa pun tanpa izin tertulis dari kami.</p>
              ...
              <p>Situs kami mungkin berisi tautan ke situs web pihak ketiga. Tautan ini disediakan semata-mata demi kenyamanan Anda. ARKAVENA tidak bertanggung jawab atas konten atau praktik privasi dari situs-situs tersebut.</p>
              
              <h3>5. Batasan Tanggung Jawab</h3>
              <p>Dalam keadaan apa pun, ARKAVENA tidak bertanggung jawab atas kerugian langsung, tidak langsung, insidental, atau konsekuensial yang timbul dari penggunaan atau ketidakmampuan Anda dalam menggunakan situs web ini atau layanan yang kami sediakan.</p>
